...
const ru = {
  ...
  settings: {
    ...
    telemetryDescription:
      'При запуске приложения отправляются анонимный идентификатор установки, версия, платформа и язык интерфейса для подсчёта активных пользователей. Microsoft определяет примерные страну и город по IP-адресу подключения. Содержимое сеансов не отправляется.',

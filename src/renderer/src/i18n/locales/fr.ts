...
const fr = {
  app: {
    name: 'Session Lens',
    tagline: "Limites d'utilisation IA",
  },
  common: {
    loading: 'Chargement…',
  },
  ...
  settings: {
    ...
    telemetryDescription:
      "Au démarrage de l'application, un identifiant d'installation anonyme, la version, la plateforme et la langue de l'interface sont envoyés pour compter les utilisateurs actifs. Microsoft déduit un pays et une ville approximatifs de l'adresse IP de connexion. Aucun contenu de session n'est envoyé.",
  ...
  providers: {
    ...
    warmWindow: 'Fenêtre de préchauffage',
    apiKey: 'Clé API',
    envKeyDescription:
      'Cette clé est chargée depuis une variable d’environnement et ne peut pas être modifiée ici.',
  ...
  notifications: {
    ...
    criticalThresholdDescription:
      "Pourcentage d'utilisation déclenchant un avertissement critique.",

 ...
 * @description Prepends a severity-level emoji to notification messages so that tray
 * balloons and remote channel messages carry a visual indicator of the notification level.
 */
